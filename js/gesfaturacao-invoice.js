jQuery(document).ready(function ($) {
          ...
          $.ajax({
            ...
            success: function (response) {
              if (response.success) {
                ...
                wpAdminNotice(
                  "Ocorreu um erro ao criar a fatura: " +
                    (response.data.message ||
                      "Erro desconhecido, por favor contacte o Administrador"),
                  "error"
                );
              }
            },
  ...
  $("#exemptionModal").on("submit", "#exemptionForm", function (e) {
    ...
    let order_id = 0;
    $(this)
      .find('select[name^="exemption_reason"]')
      .each(function () {
      ...
      html += `<tr>
            ...
            <td style="width:50%">
                <select name="exemption_reason[${
                  item.product_id
                }]" data-order_id="${order_id}" class="select2Modal" style="width:100%">
